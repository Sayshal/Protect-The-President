...
surface.CreateFont( "suiscoreboardplayerstatus", {
	font = "Trebuchet",
	size = 20,
	weight = 800
})
...
function PANEL:Paint( w, h )
	draw.RoundedBox( 10, 0, 0, self:GetWide(), self:GetTall(), Color( 25, 25, 25, 220 ) )
	...
	// Sub Header
	draw.RoundedBox( 6, 108, self.Description.y - 4, self:GetWide() - 128, self.Description:GetTall() + 8, Color( 255, 255, 255, 155 ) )
	surface.SetTexture( texGradient )
...
function PANEL:PerformLayout()
	...
	self.SuiSc:SetPos( self:GetWide() - 80, self:GetTall() - 15 )

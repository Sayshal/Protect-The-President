...
UPGRADE_TMEMBERWEP = AddUpgrade("t_memberwep", "Member Wep Upgrade", "Upgrade your MAC 10 to UMP for Terrorist Member class.", "models/weapons/w_hk_ump45.mdl", "Terrorist", {{price = 100, value = 1, donator = false}})
